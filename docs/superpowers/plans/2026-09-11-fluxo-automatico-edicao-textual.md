...
- [x] Ouvir o trecho original sobre Nilton Pinto e Tom Carvalho e localizar onde houve perda: saída ASR, palavra sem alinhamento, speech_index, seleção ou render. Registrar tempos e camada comprovada. Corrigir a causa dentro dos módulos já previstos; não declarar causa apenas porque o catálogo omitiu o nome.
